...
export const javascriptAsynchronousSections: ArticleSection[] = [
  ...
  {
    id: "how-the-await-example-works", heading: "What happens in the example",
    paragraphs: [
      "**async** lets getHounds() use await.",
      "**fetch()** asks the server for hound data and returns a promise immediately.",
      "**The first await** gives response the Response object after the server replies.",
      "**response.json()** reads the response body and returns another promise.",
      "**The second await** gives data the JSON information from that response.",
      "**The browser and other JavaScript** can keep working while getHounds() waits.",
