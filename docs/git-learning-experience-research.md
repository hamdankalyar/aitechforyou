...
[^8]: AI Tech For You local project. [Configuration article](../lib/git-config-article.ts), [snapshot article](../lib/git-first-article.ts), [article archive](../app/articles/page.tsx), and [article renderer](../app/articles/[slug]/page.tsx). Inspected September 11, 2026. Local source files, not public analytics.
