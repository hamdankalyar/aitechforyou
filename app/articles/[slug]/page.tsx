        ...
        <div className="article-prose">
          {sections.map((section, index) => (
            <section key={section.id} id={section.id}>
              ...
              {section.code && (runnableCode ? <CodeRunner code={section.code} page={section.page} /> : <pre tabIndex={0} aria-label="Code example"><code>{section.code}</code></pre>)}
